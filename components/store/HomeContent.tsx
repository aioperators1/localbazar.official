...
export function HomeContent({ selectionProducts, selectionCategory }: { selectionProducts: Product[], selectionCategory: Category }) {
    ...
    return (
        <section className={isAr ? 'rtl' : 'ltr'}>
            ...
            <section className="py-32 sm:py-48 bg-transparent overflow-hidden">
                <div className="container mx-auto px-6 lg:px-24">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-24 lg:gap-40">
                        <ScrollReveal delay={0.1} className="space-y-12 group cursor-default">
                            <div className="flex items-center gap-6">
                                <div className="w-12 h-[0.5px] bg-white/20 group-hover:w-20 group-hover:bg-white transition-all duration-1000 ease-out" />
                            ...
                            <h3 className="text-[32px] lg:text-[40px] font-serif tracking-tighter text-white leading-[1.1] transition-all duration-1000 group-hover:translate-x-2">
                        ...
                        <ScrollReveal delay={0.3} className="space-y-12 group cursor-default">
                            <div className="flex items-center gap-6">
                                <div className="w-12 h-[0.5px] bg-white/20 group-hover:w-20 group-hover:bg-white transition-all duration-1000 ease-out" />
                        ...
                        <ScrollReveal delay={0.5} className="space-y-12 group cursor-default">
                            <div className="flex items-center gap-6">
                                <div className="w-12 h-[0.5px] bg-white/20 group-hover:w-20 group-hover:bg-white transition-all duration-1000 ease-out" />
