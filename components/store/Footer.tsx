            ...
            <div className="container mx-auto px-4 lg:px-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-[12px] text-white/50 leading-loose font-medium max-w-xs uppercase tracking-widest">
                            Bringing you the finest in luxury fashion and scents. A signature of elegance since 2013.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <FooterLink href="/shop?category=abayas">Abayas</FooterLink>
                            <FooterLink href="/shop?category=jalabiyas">Dresses & Jalabiyas</FooterLink>
                            <FooterLink href="/shop?category=men">Men's Collection</FooterLink>
                            <FooterLink href="/shop?category=perfumes">Perfumes & Oud</FooterLink>
                            <FooterLink href="/shop?category=new-arrivals">New Arrivals</FooterLink>
                        </ul>
                    </div>

                    {/* Boutique */}
                    <div>
                        <h4 className="text-white font-bold text-[11px] uppercase mb-8 tracking-[0.2em]">Company</h4>
                        <ul className="space-y-4">
                ...
                <div className="mt-24 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[9px] text-white/30 font-medium uppercase tracking-[0.3em]">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <p>&copy; 2026 LOCAL BAZAR. ALL RIGHTS RESERVED.</p>
