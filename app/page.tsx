...
export default async function Home() {
  ...
  const displayProducts = featuredProducts.length > 0 ? featuredProducts : [
    // GAMING LAPTOPS
    { id: '1', name: 'Razer Blade 16', slug: 'razer-blade-16', price: 32990, category: { name: 'Laptops' }, images: 'https://images.unsplash.com/photo-1624705002806-5d72df19c2ba?q=80&w=1000', specs: null },
    { id: '2', name: 'MacBook Pro M3 Max', slug: 'macbook-pro-m3-max', price: 45900, category: { name: 'Laptops' }, images: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=1000', specs: null },

    // COMPONENTS
    { id: '3', name: 'RTX 4090 SUPRIM X', slug: 'rtx-4090-suprim-x', price: 24900, category: { name: 'Components' }, images: 'https://images.unsplash.com/photo-1591488320449-011701bb6704?q=80&w=1000', specs: null },
    { id: '4', name: 'AMD Ryzen 9 7950X', slug: 'amd-ryzen-9-7950x', price: 6500, category: { name: 'Components' }, images: 'https://images.unsplash.com/photo-1555618568-d0505164f986?q=80&w=1000', specs: null },

    // CONSOLES & GAMING
    { id: '5', name: 'PlayStation 5 Pro', slug: 'playstation-5-pro', price: 8490, category: { name: 'Consoles' }, images: 'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?q=80&w=1000', specs: null },
    { id: '6', name: 'Xbox Series X', slug: 'xbox-series-x', price: 6990, category: { name: 'Consoles' }, images: 'https://images.unsplash.com/photo-1621259182902-38006d09fde0?q=80&w=1000', specs: null },

    // PERIPHERALS
    { id: '7', name: 'Logitech G Pro X 2', slug: 'logitech-g-pro-x-2', price: 1890, category: { name: 'Peripherals' }, images: 'https://images.unsplash.com/photo-1615663245857-ac93bb7c39e7?q=80&w=1000', specs: null },
    { id: '8', name: 'Keychron Q1 Pro', slug: 'keychron-q1-pro', price: 2200, category: { name: 'Peripherals' }, images: 'https://images.unsplash.com/photo-1595225476474-87563907a212?q=80&w=1000', specs: null },
  ];
